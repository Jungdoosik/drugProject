	...
	<div class="container my-fade-in">
		...
		<div class="row">
			<div class="align-self-center text-center" style="margin-top: 50px;">
				<h1 class="title">일주일체험으로 
				<span class="title" style="color: rgb(237, 28, 36);">"MedicineSearch"에서
				<br>10,000캐시도 받고 </span> 약성분을 확인하자
				</h1>
			
				<div class="korea mb-4">
					<img src="resources/images/free-icon-drug-4667352.png" 
					style="margin-bottom: 40px; width: 50%; height: 50%; border-bottom: 1.5px solid #C0C0C0; border-radius: 13px;">
				</div>

				<div class="terms">
					<label for="agree_all" style="font-size: 20px;"> 
					<input type="checkbox" name="agree_all" id="agree_all"> 
					<span class="agree_all_click" style="font-size: 20px; color: red">전체 동의</span>
					</label> 
					<br> 
					<label> 
					<input type="checkbox" id="agree1" name="agree" value="1"> 
					
						<span class="termsAlert" name="#agree1" title='이용약관 동의'question='<div class="input-text" style=" color:gray; border: 2px solid rgb(213, 213, 213); padding :10px; font-size:7pt; height:140px; border-radius:8px; overflow: auto;">
							<span>제1조(목적)<br> 
    						...
    						3. 기타 “몰”이 정하는 업무<br>
  							...
  							④ 전항의 경우 “몰”은 이로 인하여 이용자가 입은 손해를 배상합니다. 다만, “몰”이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.</span><br></div>'>이용약관
							동의<strong> (필수)</strong>
					</span>
					</label> <br> <label> 
					<input type="checkbox" id="agree2" name="agree" value="2"> 
					<span class="termsAlert" name="#agree2" title='개인정보 수집'
						question='<div class="input-text" style="color:gray; font-size:2px;border: 2px solid rgb(213, 213, 213); padding :10px; font-size:7pt; height:140px; border-radius:8px; overflow: auto;">
							<span>개인정보처리방침<br> 
							<br>
							1. 총칙<br>
 							<br>
						...
						question='<div class="input-text" style="color:gray; font-size:2px;border: 2px solid rgb(213, 213, 213); padding :10px; font-size:7pt; height:140px; border-radius:8px; overflow: auto;">
							...
							<br>
  							...
  							이용자 및 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만아동의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다. 이용자 혹은 만 14세 미만 아동의 개인정보 조회,수정을 위해서는 ‘개인정보변경’(또는 ‘회원정보수정’ 등)을 가입해지(동의철회)를 위해서는 “회원탈퇴”를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다.혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다.<br>
						...
						name="#agree4" title='이벤트, 혜택정보 수신동의'
						question='<div class="input-text" style="color:gray;font-size:2px;border: 2px solid rgb(213, 213, 213); padding :10px; font-size:7pt; height:140px; border-radius:8px; overflow: auto;">
							<span>이벤트 응모를 위한 개인정보 수집 이용 동의서<br> 
							<br>
							본인은 귀사의 마케팅 활동 참여를 위해 귀사가 본인의 개인 정보를 수집이용하고자 하는 경우 개인정보보호법 제15조, 제22조에 따라 동의를 얻어야 합니다. 이에 이벤트 응모 및 경품 지급을 위하여 아래와 같이 개인정보를 수집 이용 및 제공하고자 합니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오.<br>
 							<br>
							개인정보 수집 이용 내역<br>
 							항목 : 이벤트 응모 내용(이름,휴대폰번호,예약번호)<br>
 				 			수집 및 이용 목적 : 이벤트 당첨자 본인 확인, 경품 수령 조건 확인, 경품 지급<br>
							보유기간 : 경품 지급 완료 후 최대 3개월(지급 내용 및 관련 문의 응대 완료 후 폐기)<br>
							<br>
 	 						당사는 이벤트 진행 및 경품 지급을 위하여 아래와 같이 업무를 처리 합니다<br> 
  							수탁사 : 한국비앤시<br>
  							목적 : 경품발송<br>
  							위의 개인정보 수집 이용에 대한 동의를 거부할 권리가 있습니다. 그러나, 동의를 거부할 경우 이벤트 진행 및 서비스 제공 대상에서 제외됨을 알려드립니다.<br>
    						</span><br></div>'>이벤트,
					...
					<div class="intro-btn">
						<button class="event_btn1"  id="goBtn">가입하고
							보상받기</button>
					</div>
				</div>
			</div>
		...
		<hr style="border: dotted 1px rgb(121, 159, 189);">
		<div class="intro-content">
			<span> 본 서비스는 "(주)MedicineSearch" 에서 운영합니다. 고객센터
				info@example.com / 대표번호 : 02-1234-5678 <br> 7일(168시간) 무료체험 종료 후
				서비스 정상금액 4,900원이 매월 결제됩니다. <br> 해당 상품의 해지 신청은 대표번호로 전화 후 상담 시
				해지해드립니다.<br> (72시간 저희 서비스를 이용하시는 조건으로 보상을 지급합니다.)<br>
				무료기간이 끝나 결제가 진행되면 최초 한달은 의무사용 약정이 적용되어 취소/환불이 진행되지 않습니다.</br>
			</span> <span style="line-height: 60px;"> 서비스 해지와 문의는 홈페이지 상단 '서비스해지'
				'문의'를 통해 가능합니다. <br>
			</span>
		</div>
	</div>
