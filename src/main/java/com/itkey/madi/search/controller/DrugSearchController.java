package com.itkey.madi.search.controller;
...
import com.itkey.controller.ApiController;
...
public class DrugSearchController {
	...
	public Map<String, Object> drugUse(@RequestParam Map<String,Object> params) throws Exception {
		...
		String itemSeq = (String) params.get("itemSeq");
		String itemName = (String) params.get("itemName");
		 StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1471000/DrbEasyDrugInfoService/getDrbEasyDrugList"); 
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=wGR4f0Ag6dwaYjwXL5SgUnGgAEM2A24RAQeFZZBxvTfoWyadY%2B4h6x6LOkro%2FjqYv%2BwMfTiSW9vIrwGwrfjlKw%3D%3D");
	...
	//모양검색 List
	@RequestMapping("/searchDrugShapeList")
	public String searchShapeList(@RequestParam Map<String,Object> params, 
		...
		params.put("end", end);
		params.put("cntPerPage", Integer.parseInt(cntPerPage));

		List<DrugShapeVo> list = drugSearchService.searchShapeList(params);
		int totalCnt = drugSearchService.searchShapeListCnt(params);
	    ...
	    params.put("nowPage", nowPage);
	    params.put("cntPerPage", cntPerPage);
	    vo = new PagingVo(totalCnt, Integer.parseInt(nowPage), Integer.parseInt(cntPerPage));
    	model.addAttribute("paging", vo);
    	model.addAttribute("list", list);
        model.addAttribute("params", params);
	
        return "searchDrugShapeList";
	}
	
	//모양검색 List
	@ResponseBody
	@RequestMapping("/searchDrugShapeListP")
	public Map<String, Object> searchDrugShapeListP(@RequestParam Map<String,Object> params, 
			PagingVo vo,
			DrugShapeVo dVo,
			@RequestParam(value="nowPage", required=false, defaultValue="1")String nowPage, 
			@RequestParam(value="cntPerPage", required=false, defaultValue="10")String cntPerPage, 
	...
	@RequestMapping("/drugShapeDetail")
	public String drugShapeDetail(@RequestParam Map<String, Object> params, ModelMap model) throws Exception{
		
		System.out.println(params);
		model.addAttribute("params", params);
		
		return "drugShapeDetail";
	}
}
