...
public class DrugShapeVo {
	...
	private String imgRegistTs;			//약학정보원 이미지 생성일
	...
	public String getMarkCodeBackImg() {
		return markCodeBackImg;
	}
	public void setMarkCodeBackImg(String markCodeBackImg) {
	...
	public String toString() {
		return "DrugShapeVo [itemSeq=" + itemSeq + ", itemName=" + itemName + ", entpSeq=" + entpSeq + ", entpName="
				...
				+ markCodeFrontAnal + ", markCodeBackAnal=" + markCodeBackAnal + ", markCodeFrontImg="
				+ markCodeFrontImg + ", markCodeBackImg=" + markCodeBackImg + ", changeDate=" + changeDate
				+ ", markCodeFront=" + markCodeFront + ", markCodeBack=" + markCodeBack + ", itemEngName=" + itemEngName
				+ ", edlCode=" + edlCode + "]";
	}
